...
public class Main2 {
	...
	//	abd.imprimirDepartamento(10);
		...
		//System.out.println(abd.incrementarSalario(100));
		
		//System.out.println(abd.incrementarSalarioOficio("Empleado", 200));
		
		System.out.println(abd.incrementarSalarioDepartamento(30, 200));
